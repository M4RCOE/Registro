...
<div id='user'  class='mr-5'>
      <table class="table table-hover ml-4 mr-4 border-end display" id="table"   >
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div id='modalU' class="modal-body">
          ...
          <label >Foto</label><br>
          <input class=' border-0 text-center' type="file" name='imgU' id='imgU' style='width:250px'><hr class='mt-0 pt-0' style='width:250px'><br>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div id='modalU' class="modal-body">
         ...
         <!--  <label hidden>Menu</label><br>
          <select class="select" id='MUserA' hidden>
