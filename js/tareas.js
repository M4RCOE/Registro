                    ...
                    for (var h, l = dm = "M" == this.f ? 1 : 0 == o ? -5 : 2, v = (c = 0, 0); v < 6; v++) {
                        ...
                        for (var m = 0; m < 7; m++) {
                            if ((h = c + dm - o) < 1) d += '<div class="cell disable">' + (u - o + l++) + "</div>";
                                ...
                                d += '<div style="width:5%; height:10% "class="cell' + (r == h && this.CurrentMonth == n && this.CurrentYear == a ? " active" : "") + '"><span onclick="fecha(this)" style="width:1px; ">' + h + "</span></div>", l = 1
                            }
                            c % 7 == 6 && h >= i && (v = 10), c++
                        }
                        d += "</div>"
                ...
                function fecha(obj) {
                    ...
                    f = d.split(/\s{3}/)
                    console.log(obj.innerText + " " + f)
                    let fech = new Date(f[0] + " " + obj.innerText + ", " + f[1]);
                    console.log(fech.getDate())
                    document.getElementById('fecha').value=f[0] + " " + obj.innerText + ", " + f[1]
                ...
                function tarea() {
                    ...
                    let contenedor = document.getElementById('contiene');
